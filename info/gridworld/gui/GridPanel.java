...
import resources.TerritoryInfo;
        ...
        PseudoInfiniteViewport.Pannable
{
    ...
    private void drawOccupant(Graphics2D g2, int xleft, int ytop, Object obj)
    {
		...
		Ellipse2D bgCircle = new Ellipse2D.Float((float)xleft, (float)ytop, (float)cellSize, (float)cellSize);
        ...
        if (cellToDraw.intersects(g2.getClip().getBounds()))
        {
			...
			if (obj instanceof TerritoryInfo)
				displayObj.draw(obj, this, g2copy, cellToDraw, bgCircle);
			else
