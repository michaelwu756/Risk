...
public class GUIController<T>
{
    ...
    private Timer timer;
    private JButton stepButton, runButton, stopButton, doneButton, cardsButton;
	...
	private int whichButton = 0; // mouse button
            ...
            DisplayMap displayMap, ResourceBundle res)
    {
        ...
        display.addMouseListener(new MouseAdapter()
        {
            public void mousePressed(MouseEvent evt)
            {
				...
				whichButton = evt.getModifiers();//gets mouse button
	...
	public void done()
	{
		parentFrame.getWorld().nextPhase();
		parentFrame.repaint();
	}
	public void showCards()
	{
		parentFrame.getWorld().showSelector();
	}
    /**
    ...
    private void makeControls()
    {
		...
		doneButton = new JButton(resources.getString("button.gui.done"));
		cardsButton = new JButton(resources.getString("button.gui.cards"));
