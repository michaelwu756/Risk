...
public class DefaultDisplay implements Display
{
    ...
    public void draw(Object obj, Component comp, Graphics2D g2, Rectangle rect)
    {
        ...
        //if (color == null && obj instanceof Color)
            //color = (Color) obj;
		color = null;//Creates transparent background
        Color textColor = (Color) AbstractDisplay.getProperty(obj, "color");//textColor
	...
	public void draw(Object obj, Component comp, Graphics2D g2, Rectangle rect, Ellipse2D circle)
    {
        Color color = (Color) AbstractDisplay.getProperty(obj, "color");
        if (color == null && obj instanceof Color)
            color = (Color) obj;
